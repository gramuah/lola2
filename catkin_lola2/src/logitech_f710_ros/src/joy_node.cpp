...
private:
    ...
    int linear_x_{1}, linear_y_{2}, angular_z_{0};
    double lin_x_slow_{0.1}, lin_y_slow_{0.1}, ang_z_slow_{0.1};
    double lin_x_normal_{0.2}, lin_y_normal_{0.2}, ang_z_normal_{0.2};
    double lin_x_fast_{0.3},lin_y_fast_{0.3}, ang_z_fast_{0.3};
...
TeleopJoy::TeleopJoy()
{
    ...
    nh_.param("/f710_teleop_joy_node/linear_x_", linear_x_, linear_x_);
